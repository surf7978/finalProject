...
<body>
	...
	<form id="frm" action="updateHospital" encType="multipart/form-data" method="post">
		...
		<table border="1">
			...
			<tr>
				<th>진료명</th>
				<td  colspan="2"><input type="text" name="name" id="name" value="${hospital.name }"></td>
			</tr>
			<tr>
				<th>옵션명</th>
			...
			<tr>
				<th>상세 이미지</th>
				<td colspan="2"><input type="file" name="uploadFile" id="image" size="100%" multiple="multiple"></td>
			</tr>
			<tr>
				<th>미리보기</th>
