...
<script>
	function getSearchHospital(p) {
		...
		$.ajax({
			...
			success : function(datas) {
				...
				$(response).each(
						function(i) {
							var hospitalNumber = response[i].hospitalNumber;
	...
	$(function() {
		...
		$("#contents").on("click", "#show li", function(hospitalNumber) {
			...
			location.href = "getHospital?hospitalNumber=" + hospitalNumber;
		});		
		//pro_location
