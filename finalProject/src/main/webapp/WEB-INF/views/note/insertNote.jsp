...
<h3>의료내역 등록</h3>
	<form id="frm" action="insertNote" method="post">
		...
		<table class="table6">
			...
			<tr>
				<th>의료일</th>
				<td class="noteTd"><input type="date" id="calendar" name="calendar" style="width: 200px;"></td>
			</tr>
			<tr>
				<th>의료비</th>
				<td class="noteTd"><input type="number" id="price" name="price" style="width: 200px;"></td>
			</tr>
			<tr>
				<th>메모</th>
