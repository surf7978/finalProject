...
$(function(){
	...
	if(today.getFullYear()-birth[0] > 1) {
		if(today.getMonth()+1-birth[1]>0) {
			$("#ttt").text((today.getFullYear()-birth[0])+"세 "+(today.getMonth()+1-birth[1])+"개월");
		} else {
			$("#ttt").text((today.getFullYear()-birth[0])+"세 "+(today.getMonth()+1-birth[1]+12)+"개월");
		} 
	//1년 차이
		...
		if(today.getMonth()+1-birth[1]>0) {
			...
			$("#ttt").text((today.getMonth()+1-birth[1]+12)+"개월");
		}
		//같은 년도
	}	else if (today.getFullYear()-birth[0] == 0) {
		if(today.getMonth()+1-birth[1]>0) {
			$("#ttt").text((today.getMonth()+1-birth[1])+"개월");
...
<h3>반려동물 의료수첩</h3><br>
	...
	<table class="table4">
		...
		<tr>
			<td>
			생후 1년 3개월<br>
			- 추가 예방접종 1차 *권장일:<a class="birth6"></a>
			</td>
			<td>
			<c:forEach begin="0" end="${note.size() }" var="i">
		...
		<tr>
			<td>
			생후 2년 3개월<br>
			- 추가 예방접종 2차 *권장일:<a class="birth7"></a>
			</td>
			<td>
			<c:forEach begin="0" end="${note.size() }" var="i">
		...
		<tr>
			<td>
			생후 3개월 1주<br> 
			- 심장사상충 예방약 *권장일:<a class="birth2"></a>
			</td>
			<td>
			<c:forEach begin="0" end="${note.size() }" var="i">
		...
		<tr>
			<td>
			생후 12개월<br>
			- 심장사상충 예방주사 *권장일:<a class="birth8"></a>
			</td>
			<td>
			<c:forEach begin="0" end="${note.size() }" var="i">
